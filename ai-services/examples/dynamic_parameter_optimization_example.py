"""
Example usage of the Dynamic Parameter Optimization system
"""
...
async def example_real_time_optimization():
    ...
    result = await optimizer.optimize_for_composition(
        INITIAL_COMPOSITION,
        ProcessingStage.SORTING
    )
    ...
    print("\nStopping real-time optimization...")
    optimizer.stop()
