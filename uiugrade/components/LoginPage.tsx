          ...
          <form className="space-y-6" onSubmit={(e) => { e.preventDefault(); onSuccess(); }}>
             <div className="group/input">
               ...
               <div className="relative">
                  ...
                  <input type="email" className="w-full bg-black border border-white/10 text-white pl-10 pr-4 py-3 text-sm focus:border-primary focus:ring-1 focus:ring-primary outline-none transition-colors" placeholder="name@company.com" />
               </div>
             </div>
             ...
             <div className="group/input">
               ...
               <div className="relative">
                  ...
                  <input type="password" className="w-full bg-black border border-white/10 text-white pl-10 pr-4 py-3 text-sm focus:border-primary focus:ring-1 focus:ring-primary outline-none transition-colors" placeholder="••••••••" />
               </div>
             </div>
             ...
             <button type="submit" className="w-full bg-primary hover:bg-cyan-400 text-black font-bold py-3 uppercase tracking-wider text-sm transition-all relative overflow-hidden group/btn">
