       ...
       <div className="w-full max-w-lg bg-surface-dark border border-white/10 p-8 relative z-10 shadow-2xl animate-fade-in group">
          ...
          <div className="text-center mb-8 relative">
             ...
             <div className="grid grid-cols-2 gap-4">
                 <div>
                   <label className="block text-xs font-mono text-gray-500 uppercase mb-2">Full Name</label>
                            <input
                               type="text"
                               className="w-full bg-black border border-white/10 text-white px-4 py-3 text-sm focus:border-primary focus:ring-1 focus:ring-primary outline-none transition-colors"
                               value={fullName}
             ...
             <div className="grid grid-cols-2 gap-4">
                 ...
                 <div>
                   <label className="block text-xs font-mono text-gray-500 uppercase mb-2">Role</label>
                              <select
                                 className="w-full bg-black border border-white/10 text-white px-4 py-3 text-sm focus:border-primary focus:ring-1 focus:ring-primary outline-none transition-colors appearance-none"
                                 value={role}
             ...
             <button
               type="submit"
               disabled={loading}
               className="w-full bg-white hover:bg-gray-200 disabled:bg-gray-600 disabled:text-gray-300 disabled:cursor-not-allowed text-black font-bold py-3 uppercase tracking-wider text-sm transition-colors mt-4 relative group/btn overflow-hidden"
             >
                <span className="relative z-10">{loading ? 'Registering...' : 'Request Access'}</span>
